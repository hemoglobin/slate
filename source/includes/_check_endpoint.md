...
The desired data is stored in the `data` property. Here you can inspect details regarding the IP address queried, such as version and country of origin. And of course, there is the valuable abusive reports.
